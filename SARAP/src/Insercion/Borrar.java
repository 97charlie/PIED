...
public class Borrar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("BORRAR REGISTROS");
        ...
        setSize(new java.awt.Dimension(340, 317));
    ...
    private void jButtonBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBorrarActionPerformed
        ...
        String limite = " "; // Elemento que separa la clave, el autobus y la Ruta dentro del fichero
        String[] trozos; // Dividimos la linea del dichero en unidades independientes
        String nombre; // clave el usuario ha introducido en el cuadro de texto
